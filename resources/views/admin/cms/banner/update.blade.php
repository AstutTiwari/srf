    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">Tenantden Homepage Banner Settings</h4>
            </div>
        </div>
    </div> 
    <div class="row">
		                        	...
		                        	<div class="row no-margin">
                                        ...
                                        <div class="mb-3 col-md-6">
		                                    <label class="col-form-label" for="order">Banner Order<span class="required">*</span></label>
		                                    	{!! Form::select('order', ['1'=>'First','2'=>'Second','3'=>'Third'], @$banner->order, ['id'=>'order', 'class' => 'form-control selectpicker',  'title' => 'Select Banner Order']); !!}
