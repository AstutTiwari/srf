...
<style>
    ...
    #subProductTable.dataTable>tbody>tr.child ul.dtr-details>li{
                ...
                <div class="card-body leads-table-body">
                    <div class="section-title-top">
                        <div class="title-left">
                          ...
                          <h4 class="header-title">Sub Product List</h4>
                        </div>
                        <div class="title-right"> 
                            <a href="{{route('admin.subproduct.create.view')}}"  class="btn btn-top btn-primary test-btn btn-cancel mr-2"><i class="mdi mdi-plus-circle-outline mr-1"></i>Add A Sub Product</a>
                        </div>
                    </div>
                    <table id="subProductTable" class="table dt-responsive nowrap w-100">
                        <thead>
                            <tr>
                                <th>Logo</th>
                                <th>Name</th>
...
<script>
  ...
  var initialized = false;
	table_instance = $('#subProductTable').DataTable({
    "lengthChange": false,
    "language": {
        "paginate": {
