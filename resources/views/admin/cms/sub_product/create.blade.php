		                        ...
		                        <div class="settings-form">
		                        	<div class="row no-margin">
                                        ...
                                        <div class="mb-3 col-md-6">
									    	...
									    	{!! Form::select('category_id',$category,'',['class'=>'form-control selectpicker','data-live-search' => "true",'data-size' => "4",'id'=>'category_id','placeholder'=>'Please select the category']) !!}
