                ...
                <div class="card-body leads-table-body">
                    <div class="section-title-top">
                        <div class="title-left">
                          ...
                          <h4 class="header-title">Popular Product List</h4>
                        </div>
                        <div class="title-right">
                            <a href="{{route('admin.popularproduct.create.view')}}"  class="btn btn-top btn-primary test-btn btn-cancel mr-2"><i class="mdi mdi-plus-circle-outline mr-1"></i>Add A Product</a>
                        </div>
                    </div>
...
<script>
  ...
  var initialized = false;
    ...
    ajax: {
        url: "{{ route('admin.popularproduct.list') }}",
        method: 'POST',
