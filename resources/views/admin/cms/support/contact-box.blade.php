                ...
                <div class="card-body">
                	<div class="row">
                		<div class="banner-page-section col-md-12">
		                    <form id="contact-support_box">
		                        <div class="settings-form">
		                        	<div class="row no-margin">
                                        <div class="mb-3 col-md-6">
		                                    <label class="col-form-label" for="title">Title<span class="required">*</span></label>
                                            <input type="hidden" name="box_count" class="form-control" id="box_count" value="{{@$support_box->box_count}}"/>
                                            <input type="text" name="title" class="form-control" id="title" value="{{@$support_box->title}}"/>
										...
										<div class="mb-3 col-md-12">
											...
											<textarea class="form-control required" name="text" id="text">{{@$support_box->text}}</textarea>
...
$(document).ready(function () {
    ...
    submitHandler: function(form) {
        ...
        l = Ladda.create( document.querySelector('#contact-support_box .btn-submit') );
        l.start();
        for (instance in CKEDITOR.instances) {
            CKEDITOR.instances[instance].updateElement();
        }
        $.ajax({
            url: "{{route('admin.cms.support.contact-first-update')}}",
            method: "POST",
            dataType: 'json',
            data: $("#contact-support_box").serialize(),
