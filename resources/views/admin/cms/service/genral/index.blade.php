                ...
                <div class="card-body">
                	  <div class="row">
                	    <div class="banner-page-section col-md-12">             	
		                      <form id="homepage-genral_services">
    	                            <div class="settings-form">
    	                          	    <div class="row no-margin">
    								        <div class="mb-3 col-md-12">
    	                                        <label class="col-form-label" for="title">Service Title<span class="required">*</span></label>
    								            <input type="text" class="form-control required" name="title" id="title" value="{{@$genral_service->title}}">
                                            ...
                                            <div class="mb-3 col-md-12">
    	                                        <label class="col-form-label" for="text">Managing Text<span class="required">*</span></label>
    								           	<textarea class="form-control required" name="text" id="text">{{@$genral_service->text}}</textarea>
...
@endsection 
    ...
    var l;
    $('#homepage-genral_services').validate({
    ...
    submitHandler: function(form) {
        ...
        l = Ladda.create( document.querySelector('#homepage-genral_services .btn-submit') );
        l.start();
        for (instance in CKEDITOR.instances) {
            CKEDITOR.instances[instance].updateElement();
        }
        $.ajax({
            url: "{{route('admin.service.genral.update')}}",
            method: "POST",
            dataType: 'json',
            data: $("#homepage-genral_services").serialize(),
