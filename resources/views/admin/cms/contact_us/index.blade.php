		                        ...
		                        <div class="settings-form">
		                        	<div class="row no-margin">
										<div class="mb-3 col-md-12">
											...
											<input type="text" class="form-control required" name="title" id="title" value="{{@$contact_us->title}}">
										...
										<div class="mb-3 col-md-6">
		                                   <label class="col-form-label" for="poster">Update Poster<span class="required">*</span></label>
                                            ...
                                            <ul class="warning-listing">
                                                ...
                                                <li><i class="fa fa-check" aria-hidden="true"></i>The Image dimensions should be <strong>1686.25*347.23</strong> for better preview!!</li>
                                                <li><i class="fa fa-check" aria-hidden="true"></i>The Image extension should be <strong>png,jpg,jpeg and less than 5 MB!!</strong></li>
                                            </ul>
                                        </div>
                                        <div class="mb-3 col-md-6">
		                                    <label class="col-form-label" for="text">Contact Poster<span class="required">*</span></label>
                                            @if(@$contact_us->poster_url)         
            							        @php
            							            $image = 'storage/'.@$contact_us->poster_url;
            							        @endphp        
            							    @endif
										    <ul class="single-upload" id="upload_image">
            							    	<li class="image-single">
            							    	   <input type="hidden" name="poster_id" id="poster_id" class="required image_ids" value="{{@$contact_us->id}}"/>
										    		<img src="{{ URL::asset($image)}}" id="uploaded_poster" name="uploaded_poster" alt="image" class="img-fluid img-thumbnail">
