					...
					<div class="col-md-9 col-sm-8 col-xs-12">
						<div class="content-blog-page">
							...
							<div class="product-grid-view">
									...
									<div class="col-md-4 col-sm-6 col-xs-6">
										<div class="item-product item-product4 text-center border">
											<div class="product-thumb">
												<a href="{{route('home.product',['id'=>$product->id])}}" class="product-thumb-link zoom-thumb"><img src="{{ URL::asset($image)}}" alt="{{$product->banner_name}}"></a>
								...
								@else
									<p>For now there is no product uploaded</p>
								@endif
