				...
				<div class="col-md-3 col-sm-4 col-xs-12">
					<div class="sidebar sidebar-left">
						...
						<div class="widget widget-product-type">
							<h2 class="widget-title title14 font-bold text-uppercase play-font">Product Best Seller</h2>
							<ul class="list-none">
								<li>
									<div class="item-product item-product-table table-custom">
										...
										<div class="product-info">
											<h3 class="title14 product-title play-font"><a href="#">Blue ring in ged palladium finish metal</a></h3>
											<div class="product-price title14 play-font">
												<del class="silver">$400.67</del>
							...
							<div class="row">
								...
								<div class="col-md-7 col-sm-12 col-xs-12">
									<div class="detail-info">
										<h2 class="product-title title24 text-uppercase dark font-bold play-font">Baiyoke Sky Hotel</h2>
										...
										<div class="detail-attr attr-color">
											<label class="title-attr">Color:</label>
										...
										<div class="detail-attr attr-size">
											<label class="title-attr">Size:</label>
											<div class="select-box">
												<select>
										...
										<div class="detail-attr qty-cart">
											...
											<a href="#" class="shop-button bg-dark addcart-link font-bold text-uppercase">Add to Cart</a>
										</div>
						...
						<div class="detail-tabs">
							<div class="detail-tab-title">
								<ul class="list-tag-detail list-none text-uppercase font-bold">
									...
									<li><a href="#tab3" data-toggle="tab">Additional</a></li>
								...
								<div class="tab-content">
									<div id="tab1" class="tab-pane active">
										<div class="detail-tab-desc clearfix">
											<div class="img-detail pull-right"><img src="images/shop/detail.jpg" alt="" /></div>
